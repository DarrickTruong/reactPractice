...
let ToDoList = React.createClass({displayName: "ToDoList",
            ...
            React.createElement("div", null, 
                ...
                React.createElement("div", {className: "form-inline"}, 
                    React.createElement("div", {className: "form-group"}, 
                        React.createElement("input", {className: "form-control", placeholder: this.state.placeholder, ref: "newTodo", value: this.state.text, onChange: this.onChange}), 
    ...
    add: function(e) {
        ...
        if (!newTodo) {
            e.preventDefault();
            this.setState({placeholder:"Please add Todo"})
        } else {
            arr.push(newTodo);
